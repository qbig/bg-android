...
public class Constants {
    ...
    public static final String USER_LOGIN_WITH_FB = "userLoginWithFb";
    public static final String LIST_OUTLETS = "listOutlets";
    public static final String REQUEST_URL = "requestUrl";
    public static final String PROFILE_URL = "profileUrl";
    public static final String ORDER_URL = "orderUrl";
    public static final String CLEAR_BILL_URL = "clearBillUrl";
    public static final String BILL_URL = "billUrl";
    public static final String RATING_URL = "ratingUrl";
    public static final String FEEDBACK_URL = "feedbackUrl";
    public static final String DISH_CATEGORY_URL = "dishCateogryUrl";
...
//	    public static final String PROFILE_URL =  "http://bigspoon.biz/api/v
// 1/profile";

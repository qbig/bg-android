...
public class CustomListOfOrderHistoryDetailsAdapter extends ArrayAdapter<String>{
	...
	public CustomListOfOrderHistoryDetailsAdapter(Activity context,String[] number,String[] dishes, String[] price) {	
